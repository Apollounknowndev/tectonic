...
public class TectonicForge {
    ...
    private void registerDensityFunctionTypes(final RegisterEvent event) {
        event.register(Registry.DENSITY_FUNCTION_TYPE_REGISTRY, helper -> helper.register("config", ConfigDensityFunction.CODEC_HOLDER.codec()));
        event.register(Registry.DENSITY_FUNCTION_TYPE_REGISTRY, helper -> helper.register("dynamic_reference", DynamicReferenceDensityFunction.CODEC_HOLDER.codec()));
        event.register(Registry.DENSITY_FUNCTION_TYPE_REGISTRY, helper -> helper.register("erosion_noise", ErosionNoiseDensityFunction.CODEC_HOLDER.codec()));
    }
